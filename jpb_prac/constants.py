...
EMSPERF_DIR = {
	...
	'pmeam05': {
		'perfpath': EMSPERF_PATH,
		'perfdirs': {'1': 'ERICSSON3G', '2': 'ERICSSON4G'}
	},
	'pmeam08': {
		'perfpath': EMSPERF_PATH,
		'perfdirs': {'1': 'ERICSSON3G', '2': 'ERICSSON4G', '3': 'ERICSSONSGSN', '4': 'HWM2000V2R3V2R12FISFTP'}
	},
	'pmeam06': {
		'perfpath': EMSPERF_PATH,
		'perfdirs': {'1': 'CACTI', '2': 'CIENADFON', '3': 'CISCO_EPNM', '4': 'CommonEAMPackage',
			'5': 'HuaweiN2000-International', '6': 'HWITSV1R1C00SPC001', '7': 'HWTNTV2R3V2R12FISFTP',
			'8': 'HWU2000-Datacom', '9': 'HWU2000-Domestic', '10': 'HWU2000-MSAN+FTTH',
			'11': 'UTStarcomNetman2020'}
	},
	'pmeam07': {
		'perfpath': EMSPERF_PATH,
		'perfdirs': {'1': 'CACTI', '2': 'CIENADFON', '3': 'CISCO_EPNM', '4': 'CommonEAMPackage',
			'5': 'HuaweiN2000-International', '6': 'HWITSV1R1C00SPC001', '7': 'HWPIVOTeSight',
			'8': 'HWPIVOTU2000', '9': 'HWTNTV2R3V2R12FISFTP', '10': 'HWU2000-Datacom',
			'11': 'HWU2000-Domestic', '12': 'HWU2000-MSAN+FTTH', '13': 'UTStarcomNetman2020'}
	}
